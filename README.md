...
- **Experience-Driven Self-Evolution**: Extracts **validated modeling decisions and repair strategies** for retrieval and reuse in new tasks, dynamically adjusting experience weights based on observed outcomes to continuously improve modeling and repair.
